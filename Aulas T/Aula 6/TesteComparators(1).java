...
/**
 * Class TesteComparators onde se criam objectos do tipo circulo e 
 * se testam várias ordenações.
 * 
 * Os alunos são encorajados a modificar o código e testar diferentes métodos de 
 * comparação.
 *
 * @author MaterialPOO
 * @version 2018/2019
...
public class TesteComparators {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Ordem Comparator por objecto passado no construtor");
